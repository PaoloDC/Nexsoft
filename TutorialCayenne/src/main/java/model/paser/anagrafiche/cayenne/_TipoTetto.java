...
/**
 * Class _TipoTetto was generated by Cayenne.
 * It is probably a good idea to avoid changing this class manually,
 * since it may be overwritten next time code is regenerated.
 * If you need to make any customizations, please use subclass.
 */
public abstract class _TipoTetto extends CayenneDataObject {

    private static final long serialVersionUID = 1L; 

    public static final String CODTET_PK_COLUMN = "CODTET";

    public static final Property<String> DESTET = Property.create("destet", String.class);
    public static final Property<List<DatiTecniciBase>> DATI_TECNICI_BASES = Property.create("datiTecniciBases", List.class);

    public void setDestet(String destet) {
        writeProperty("destet", destet);
    }
    public String getDestet() {
        return (String)readProperty("destet");
    }
